{{-- INI FILE DWOR POLI VERSI DATA SUDAH BENAR DAN UI SUDAH BAGUS DAN SESUAI --}}
            ...
            <div class="container-fluid">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <form action="{{ route('dwor.utama', ['poli' => $selectedPoli]) }}" method="GET"
                                class="form-inline">
                            ...
                            <ul class="nav">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="{{ route('dwor.utama', ['poli' => 'gigi_umum']) }}">Poli Gigi Umum</a>
                                        </li>
                                        <li><a href="{{ route('dwor.utama', ['poli' => 'jantung']) }}">Poli Jantung</a>
                                        </li>
                                        <li><a href="{{ route('dwor.utama', ['poli' => 'konservasi']) }}">Poli Konservasi
                                                Gigi</a></li>
                                        <li><a href="{{ route('dwor.utama', ['poli' => 'kulit']) }}">Poli Kulit Kelamin</a>
                                        </li>
                                        ...
                                        <li><a href="{{ route('dwor.utama', ['poli' => 'orthopedi']) }}">Poli Orthopedi</a>
                                        </li>
                                        <li><a href="{{ route('dwor.utama', ['poli' => 'penyakit_dalam']) }}">Poli Penyakit
                                                Dalam</a></li>
